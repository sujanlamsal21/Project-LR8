            ...
            <div class="card-header bg-primary">
              <div class="app-brand">
                <a href="/index.html">
                  ...
                  <span class="brand-name">Login Dashboard</span>
                </a>
              </div>
            </div>
            @if(session('success'))
              ...
              <form method="POST" action="{{ route('login') }}">
                ...
                <div class="row">
                  <div class="form-group col-md-12 mb-4">
                    <input type="email" class="form-control input-lg" aria-describedby="emailHelp" :value="old('email')" placeholder="Email" name="email">
                  </div>
