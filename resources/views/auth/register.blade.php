                  ...
                  <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="row">
                      <div class="form-group col-md-12 mb-4">
                        <input type="text" class="form-control input-lg" name="name" aria-describedby="nameHelp":value="old('name')" placeholder="Name">
                      </div>
                      <div class="form-group col-md-12 mb-4">
                        <input type="email" class="form-control input-lg" name="email" aria-describedby="emailHelp" :value="old('email')" placeholder="Email">
                      </div>
